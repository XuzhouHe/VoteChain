...
set_property PACKAGE_PIN R18  [get_ports {system_onQ}]; # "BTNR"

set_property   IOSTANDARD LVCMOS33 [get_ports {rst}];
set_property   IOSTANDARD LVCMOS33 [get_ports {system_onQ}];
...
set_property PACKAGE_PIN Y11 [get_ports {BTNL}];  # "BTNL"
set_property PACKAGE_PIN AA8 [get_ports {BTNR}];  # "BTNR"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {user_ID[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {user_ID[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {user_ID[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {user_ID[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {user_ID[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {user_ID[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {user_ID[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {user_ID[7]}];  # "SW7"

set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID[0]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID[1]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID[2]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID[3]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID[4]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID[5]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID[6]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID[7]}];
