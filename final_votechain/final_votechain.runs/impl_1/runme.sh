...
HD_PWD='C:/Users/Dyon/Desktop/WUSTL/SPRING_2019/ESE_498_EE_Capstone/Vivado/final_votechain/final_votechain.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log votechain_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source votechain_1_wrapper.tcl -notrace
