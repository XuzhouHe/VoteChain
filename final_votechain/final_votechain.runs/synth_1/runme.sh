...
HD_PWD='C:/Users/Dyon/Desktop/WUSTL/SPRING_2019/ESE_498_EE_Capstone/Vivado/final_votechain/final_votechain.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log votechain_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source votechain_1_wrapper.tcl
