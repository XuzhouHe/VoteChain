...
#
# Generated by export_simulation on Sun Apr 28 17:33:36 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './votechain_1.sh' script.

./votechain_1.sh -reset_run
...
./votechain_1.sh -noclean_files

For more information on the script, please type './votechain_1.sh -help'.
