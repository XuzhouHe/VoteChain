...
#
# Generated by export_simulation on Fri Mar 29 12:46:07 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './currt_block.sh' script.

./currt_block.sh -reset_run
...
./currt_block.sh -noclean_files

For more information on the script, please type './currt_block.sh -help'.
