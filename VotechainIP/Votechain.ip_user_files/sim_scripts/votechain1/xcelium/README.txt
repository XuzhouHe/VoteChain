...
#
# Generated by export_simulation on Sun Apr 28 16:15:44 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './votechain1.sh' script.

./votechain1.sh -reset_run
...
./votechain1.sh -noclean_files

For more information on the script, please type './votechain1.sh -help'.
