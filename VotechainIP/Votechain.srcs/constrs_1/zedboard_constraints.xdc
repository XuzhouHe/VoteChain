...
## JA Pmod - Bank 13
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {S_AXI_ARESETN_0}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {system_onQ_0}];  # "JA10"
...
set_property   IOSTANDARD LVCMOS33 [get_ports {S_AXI_ARESETN_0}];
set_property   IOSTANDARD LVCMOS33 [get_ports {system_onQ_0}];
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {LD_0[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {LD_0[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {LD_0[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {LD_0[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {LD_0[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {LD_0[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {LD_0[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {LD_0[7]}];  # "LD7"

set_property   IOSTANDARD LVCMOS33 [get_ports {LD_0[0]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {LD_0[1]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {LD_0[2]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {LD_0[3]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {LD_0[4]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {LD_0[5]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {LD_0[6]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {LD_0[7]}];
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {BTNC_0}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {BTND_0}];  # "BTND"
set_property PACKAGE_PIN N15 [get_ports {BTNL_0}];  # "BTNL"
set_property PACKAGE_PIN R18 [get_ports {BTNR_0}];  # "BTNR"
set_property PACKAGE_PIN T18 [get_ports {BTNU_0}];  # "BTNU"

set_property   IOSTANDARD LVCMOS33 [get_ports {BTNC_0}];
set_property   IOSTANDARD LVCMOS33 [get_ports {BTND_0}];
set_property   IOSTANDARD LVCMOS33 [get_ports {BTNL_0}];
set_property   IOSTANDARD LVCMOS33 [get_ports {BTNR_0}];
set_property   IOSTANDARD LVCMOS33 [get_ports {BTNU_0}];
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {user_ID_0[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {user_ID_0[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {user_ID_0[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {user_ID_0[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {user_ID_0[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {user_ID_0[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {user_ID_0[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {user_ID_0[7]}];  # "SW7"

set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID_0[0]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID_0[1]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID_0[2]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID_0[3]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID_0[4]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID_0[5]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID_0[6]}];
set_property   IOSTANDARD LVCMOS33 [get_ports {user_ID_0[7]}];
